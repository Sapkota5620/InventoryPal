...
public class CameraActivity2 extends Activity implements CameraBridgeViewBase.CvCameraViewListener2{
        ...
        public void onManagerConnected(int status) {
            switch (status){
                case LoaderCallbackInterface
                        .SUCCESS: {
                    Log.i(TAG, "OpenCv is Loaded Camera Activity");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(CameraActivity2.this, android.Manifest.permission.CAMERA) == PackageManager.PERMISSION_DENIED){
    ...
    protected void onResume() {
        ...
        if(!OpenCVLoader.initDebug()){
            ...
            Log.d(TAG, "Opencv Initialization is not done. Try Again");
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame){
        ...
        //convert convert Rgba to gray
        //Imgproc.cvtColor(mRgba,mRgba, Imgproc.COLOR_RGB2GRAY);
        //convert convert Rgba to BGRA
